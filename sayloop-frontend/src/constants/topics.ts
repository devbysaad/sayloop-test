// Frontend topic definitions (mirrored from backend config/topics.js)
// Update both files if you make changes here.
...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    prompts: [
      ...
      'What is the best food you ate while traveling?',
    ],
    tasks: [
  ...
  },
  {
    ...
    prompts: [
      ...
      'Do you prefer movies or reading books?',
