...
const SignUpPage = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden flex items-center justify-center p-6"
      ...
      <div className="hidden lg:block absolute top-20 left-16 w-52 bg-white rounded-2xl p-4 shadow-sm"
        style={{ border: '1px solid rgba(20,20,20,0.08)', animation: 'floatA 5s ease-in-out infinite' }}>
        <div className="flex items-center gap-2 mb-3">
          <div className="w-9 h-9 rounded-xl flex items-center justify-center text-white font-black text-sm"
            style={{ background: '#E8480C' }}>A</div>
          <div>
            <p className="text-xs font-black text-[#141414]">Ahmed</p>
            <p className="text-[10px] font-normal" style={{ color: 'rgba(20,20,20,0.4)' }}>Learning English</p>
          </div>
        </div>
        <div className="rounded-lg p-2" style={{ background: '#FFF4EF' }}>
          <p className="text-xs font-medium" style={{ color: 'rgba(20,20,20,0.6)' }}>"Can we practice greetings?"</p>
        </div>
      </div>
      <div className="absolute bottom-20 right-16 bg-white rounded-xl px-4 py-2 shadow-sm"
        style={{ border: '1px solid rgba(61,122,92,0.22)', animation: 'floatB 6s ease-in-out infinite' }}>
        <p className="text-xs font-black" style={{ color: '#3D7A5C' }}>340 people online now</p>
      </div>

      <div className="relative z-10 w-full max-w-md bg-white rounded-2xl p-10 shadow-sm"
        style={{ border: '1px solid rgba(20,20,20,0.08)', animation: 'fadeUp 0.5s ease' }}>
        ...
        <SignUp.Root>
          <SignUp.Step name="start">
            <div className="mb-8">
              <h2 className="text-2xl font-black text-[#141414] mb-1" style={{ letterSpacing: '-0.5px' }}>Create your account</h2>
              <p className="text-sm font-normal" style={{ color: 'rgba(20,20,20,0.5)' }}>Join and start practicing conversations</p>
            </div>
              ...
              {(isGlobalLoading) => (
                <>
                  ...
                  <p className="text-center text-sm font-normal" style={{ color: 'rgba(20,20,20,0.5)' }}>
                    ...
                    <Link to="/sign-in" className="font-black hover:underline" style={{ color: '#E8480C' }}>Sign in</Link>
                  </p>
                </>
              )}
            </Clerk.Loading>
          ...
          <SignUp.Step name="verifications">
            <SignUp.Strategy name="email_code">
              <div className="mb-8">
                <h2 className="text-2xl font-black text-[#141414] mb-1" style={{ letterSpacing: '-0.5px' }}>Verify your email</h2>
                <p className="text-sm font-normal" style={{ color: 'rgba(20,20,20,0.5)' }}>We sent a 6-digit code to your email address.</p>
              </div>
              <Clerk.GlobalError className="text-sm font-medium rounded-xl p-3 mb-4"
                style={{ color: '#E8480C', background: '#FFF4EF', border: '1px solid rgba(232,72,12,0.2)' }} />
          ...
          <SignUp.Step name="continue">
            <div className="mb-8">
              <h2 className="text-2xl font-black text-[#141414] mb-1" style={{ letterSpacing: '-0.5px' }}>Almost there</h2>
              <p className="text-sm font-normal" style={{ color: 'rgba(20,20,20,0.5)' }}>One last step to finish your account.</p>
            </div>
            <Clerk.GlobalError className="text-sm font-medium rounded-xl p-3 mb-4"
              style={{ color: '#E8480C', background: '#FFF4EF', border: '1px solid rgba(232,72,12,0.2)' }} />
            <SignUp.Action submit
